...
using project56.Localization.Dto;
using project56.Migrations.Seed.Host;
using Shouldly;
using Xunit;

namespace project56.Tests.Localization
{
    public class LanguageAppService_Tests : AppTestBase
    {
        ...
        public async Task UpdateLanguageText()
        {
            await _languageAppService.UpdateLanguageText(
                ...
                {
                    SourceName = project56Consts.LocalizationSourceName,
                    LanguageName = "en",
                    Key = "Save",
            ...
            var newValue = Resolve<ILocalizationManager>()
                .GetString(
                    project56Consts.LocalizationSourceName,
                    "Save",
