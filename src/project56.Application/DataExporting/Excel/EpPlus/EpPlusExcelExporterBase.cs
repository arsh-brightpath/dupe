...
using project56.Dto;
using project56.Net.MimeTypes;
using OfficeOpenXml;

namespace project56.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : project56ServiceBase, ITransientDependency
    {
